export const agentSteps = [
  {
    ...
    description: 'Extract and structure key business information',
  },
  {
    name: 'Strategic SWOT Analyst',
    description: 'Produce a detailed SWOT analysis',
  },
  {
    name: 'Pricing Strategy Consultant',
    description: 'Recommend the optimal pricing model',
  },
  {
    name: 'Growth Strategy Consultant',
    description: 'Create a detailed 90-day action plan',
  },
  {
    name: 'Business Report Writer',
    description: 'Assemble all research into a final report',
  },
];
