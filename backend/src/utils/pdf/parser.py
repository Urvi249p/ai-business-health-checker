import re
from reportlab.platypus import HRFlowable, Paragraph, Spacer, KeepTogether
from .styles import C_SLATE_BORDER, C_EMERALD
from .utils import (
    _clean, _fmt, _is_md_sep, _parse_md_row,
    _looks_plain_table, _split_plain
)
