...
__all__ = ['PAGE_W', 'PAGE_H', 'MARGIN_L', 'MARGIN_R', 'MARGIN_T', 'MARGIN_B', 'USABLE_W', 'C_SLATE', 'C_SLATE_MID', 'C_SLATE_LIGHT', 'C_SLATE_BORDER', 'C_EMERALD', 'C_EMERALD_LIGHT', 'C_EMERALD_MID', 'C_GREEN', 'C_GREEN_LIGHT', 'C_AMBER', 'C_AMBER_LIGHT', 'C_TEAL', 'C_TEAL_LIGHT', 'C_ROSE', 'C_ROSE_LIGHT', 'C_BODY', 'C_MUTED', 'C_WHITE', 'C_ROW_ALT', '_PHASE_COLORS', '_PHASE_LIGHTS', '_build_styles']
